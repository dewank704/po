...
function draw() {
  ...
  if(gameState === play) {
    ...
    text("AYYY YO WHAT THE YOU HAD ONE JOB AND THAT WAS TO PROTECT THE PLANET ._.",canvas.width/2-400,canvas.height/2+100);
  ...
  if(gameState === instruction) {
    ...
    textSize(50);
    text("POOPOO SHOOTER...........",canvas.width/2-300,canvas.height/2-300);
    text("I HOPE YOU DON'T ENJOY THE GAME!",canvas.width/2-300,canvas.height/2+100);
    stroke("Lime");
    fill("Green");
    textSize(35);
    textFont("Apple Chancery");
    text("year 2500 .....",canvas.width/2-300,canvas.height/2-250);
    text(" Some asteroids are coming to planet earth ",canvas.width/2-300, canvas.height/2 - 210);
    text("  DO THIS FAST I WANT TO EAT MY COOKIES AND DON'T YOU DARE DIE ON ME.",canvas.width/2-300,canvas.height/2-170);
    text(" just give up on life and die",canvas.width/2-300,canvas.height/2-130);
